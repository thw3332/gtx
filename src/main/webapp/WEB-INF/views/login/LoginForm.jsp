...
<style>
	...
	#Login_wrap #btn_div input { width: 100px; height: 68px; display: inline-block; background: #5C6583; border: none; color: white; outline: none; cursor: pointer;}
    ...
    <div id="Login_wrap">
		...
		<div id="login_div">
			<div id="login_input">
				...
				<div id="btn_div"><input type="submit" value="확인"></div>
			</div>
			<div id="login_btn">
			<input id="id_skip" type="checkbox" value="아이디 저장">아이디 저장
			
			<div id="search_btn">
			    <input type="button" value="아이디찾기" onclick="location.href='FindId'"><input type="button" value="비밀번호찾기" onclick="location.href='FindPw'">
